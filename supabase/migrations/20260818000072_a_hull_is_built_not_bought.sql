...
insert into public.hull_recipes (class_code, yard_tier, ducats, note) values
  ('barca', 1, 3000, 'A coaster. Two fittings and a stack of deal boards - the hull a house builds first.'),
  ('carlat', 2, 7000, 'The lateen caravel: weatherly, and she wants a proper rudder and a headsail to prove it.'),
  ('nau', 3, 30000, 'Four hundred tuns of hold. Live oak below the waterline, copper over it, and a year of somebody''s life.')
...
insert into want_hull_goods_0072 (class_code, good_code, qty) values
  ...
  ('barca', 'tar', 8),
  ('barca', 'cordage', 6),
  ('barca', 'ships-nails', 10),
  ('carlat', 'timber', 70),
  ('carlat', 'naval-timber', 20),
  ('carlat', 'tar', 12),
  ('carlat', 'cordage', 10),
  ('carlat', 'ships-nails', 18),
  ('nau', 'live-oak', 90),
  ('nau', 'naval-timber', 40),
  ('nau', 'timber', 60),
  ('nau', 'tar', 25),
...
insert into public.hull_recipe_items (class_code, item_code, qty) values
  ('barca', 'suit-of-sails', 1),
  ('barca', 'anchor-and-cable', 1),
  ('carlat', 'suit-of-sails', 2),
  ('carlat', 'anchor-and-cable', 1),
  ('carlat', 'rudder-and-helm', 1),
  ('carlat', 'bowsprit-and-jib', 1),
  ('nau', 'suit-of-sails', 3),
  ('nau', 'anchor-and-cable', 2),
  ('nau', 'rudder-and-helm', 1),
  ('nau', 'hold-fittings', 2),
  ('nau', 'copper-sheathing', 1)
