...
insert into want_officers_0073 (code, name, specialty, bonus_pct, wage, nation_code, home_code, blurb) values
  ('CABRALNAV', 'Pedro Álvares Cabral', 'NAVIGATOR', 7.5, 1100, 'PRT', 'LIS', 'Made Brazil by standing too far west, and swore it was intended.'),
  ('ELCANO', 'Juan Sebastián Elcano', 'NAVIGATOR', 9, 1500, 'ESP', 'CAD', 'Came home the long way, which is to say all the way round.'),
  ('CHANCELLOR', 'Richard Chancellor', 'NAVIGATOR', 6.5, 950, 'ENG', 'LON', 'Looked for a north-east passage and found Muscovy instead.'),
  ('BARENTS', 'Willem Barentsz', 'NAVIGATOR', 7, 1050, 'NLD', 'AMS', 'Wintered in the ice and kept the log to the last page.'),
  ('PIRIREIS', 'Piri Reis', 'NAVIGATOR', 8.5, 1350, 'OTT', 'IST', 'Drew a chart from twenty older ones and got the coast right.'),
  ('IBNMAJID', 'Ahmad ibn Majid', 'NAVIGATOR', 8, 1250, null, 'KOZ', 'Knew the monsoon the way a farmer knows his own field.'),
  ('ZHENGPIL', 'Fei Xin', 'NAVIGATOR', 7, 1000, 'MNG', 'MAC', 'Sailed with the treasure fleets and wrote down every landfall.'),
  ('JEONGNAV', 'Jeong Yak-jeon', 'NAVIGATOR', 5.5, 800, 'JOS', 'BUS', 'Catalogued the fishes of Heuksan while exiled among them.'),
  ('BERGENNAV', 'Hallvard Sørensen', 'NAVIGATOR', 5, 700, 'DNK', 'COP', 'Reads a sky that has not shown a star in nine days.'),
  ('VENEZNAV', 'Alvise Da Mosto', 'NAVIGATOR', 6, 900, 'VEN', 'VEN', 'A Venetian in Portuguese pay, and worth the awkwardness.'),
  ('MALACCANAV', 'Tun Perak', 'NAVIGATOR', 6.5, 900, null, 'MAL', 'Knows every shoal of the Straits and charges accordingly.'),
  ('ALBUQUERQ', 'Afonso de Albuquerque', 'QUARTERMASTER', 8, 1300, 'PRT', 'GOA', 'Stows a hold the way he took a city: nothing left over.'),
  ('MENDANA', 'Álvaro de Mendaña', 'QUARTERMASTER', 6, 850, 'ESP', 'CLL', 'Provisioned for the Solomons twice and came back thinner twice.'),
  ('HAWKINSQM', 'William Hawkins', 'QUARTERMASTER', 7, 1050, 'ENG', 'LON', 'Can find eight tuns of room in a hold that is already full.'),
  ('COENQM', 'Jan Pieterszoon Coen', 'QUARTERMASTER', 8.5, 1400, 'NLD', 'JAK', 'Ruthless about cargo and about most other things.'),
  ('HANSEQM', 'Klaus Störtebeker', 'QUARTERMASTER', 6.5, 900, 'HAN', 'LUB', 'Was a pirate, is a quartermaster; the skills overlap more than anyone admits.'),
  ('GUJARATQM', 'Malik Ayyaz', 'QUARTERMASTER', 7.5, 1150, 'MUG', 'SRT', 'Ran Diu''s harbour and never lost a bale to the rain.'),
  ('SAKAIQM', 'Imai Sōkyū', 'QUARTERMASTER', 6, 880, 'JPN', 'OSA', 'A tea master who counts cargo with the same attention.'),
  ('MOROCCOQM', 'Yusuf al-Wazzan', 'QUARTERMASTER', 5, 700, 'MAR', 'MRS', 'Crossed the Sahara with camels; a hold holds no terrors.'),
  ('SWEDQM', 'Anna Larsdotter', 'QUARTERMASTER', 5.5, 760, 'SWE', 'GDA', 'Counts iron and tar in her sleep, and is never out by a bar.'),
  ('GENOAQM', 'Andrea Doria', 'QUARTERMASTER', 7, 1080, 'GEN', 'BAR', 'Admiral, banker, and a man who knows what a ship can carry.'),
  ('GARCIAORTA', 'Garcia de Orta', 'SURGEON', 9, 1450, 'PRT', 'GOA', 'Wrote the book on the drugs of India, then used it.'),
  ('MONARDES', 'Nicolás Monardes', 'SURGEON', 7, 1050, 'ESP', 'SVQ', 'Sold the New World its own medicines back at a markup.'),
  ('WOODALL', 'John Woodall', 'SURGEON', 8, 1250, 'ENG', 'LON', 'Put lemons in the sea-chest decades before anyone listened.'),
  ('TULPSURG', 'Nicolaes Tulp', 'SURGEON', 7.5, 1150, 'NLD', 'AMS', 'Better known for a painting than for the hands in it.'),
  ('SABUNCU', 'Şerefeddin Sabuncuoğlu', 'SURGEON', 6.5, 940, 'OTT', 'IST', 'Illustrated his surgery so the next man would not guess.'),
  ('PERSSURG', 'Hakim Baha al-Din', 'SURGEON', 6, 880, 'PER', 'SRT', 'Trained at Isfahan; treats fever with something that works.'),
  ('HEOJUN', 'Heo Jun', 'SURGEON', 8.5, 1350, 'JOS', 'BUS', 'Compiled the Dongui Bogam and can set a bone besides.'),
  ('LISHIZHEN', 'Li Shizhen', 'SURGEON', 8, 1300, 'MNG', 'GUA', 'Catalogued eighteen hundred remedies and trusted forty.'),
  ('DANESURG', 'Ole Worm', 'SURGEON', 5.5, 780, 'DNK', 'COP', 'Keeps a cabinet of curiosities and a very tidy medicine chest.'),
  ('VENSURG', 'Girolamo Fracastoro', 'SURGEON', 7, 1020, 'VEN', 'VEN', 'Said disease travels by seeds. Nobody believed him yet.'),
  ('MALSURG', 'Bidan Rahmah', 'SURGEON', 5, 700, null, 'MAL', 'Learned her herbs in the Straits, where the fevers are worst.'),
  ('WELSER', 'Bartholomäus Welser', 'PURSER', 9, 1600, 'HAN', 'HAM', 'Lent to an emperor and took Venezuela as security.'),
  ('MEDICI', 'Filippo Strozzi', 'PURSER', 8, 1300, 'GEN', 'BAR', 'Florentine banking, applied to a ship''s accounts.'),
  ('GRESHAM', 'Thomas Gresham', 'PURSER', 8.5, 1400, 'ENG', 'LON', 'Bad money drives out good; he made sure yours was good.'),
  ('AMSPURSER', 'Dirck van Os', 'PURSER', 7.5, 1180, 'NLD', 'AMS', 'Helped found the Company and never once rounded up.'),
  ('PORTPURSER', 'Duarte Brandão', 'PURSER', 6.5, 950, 'PRT', 'LIS', 'Keeps the Casa da Índia''s books and his own counsel.'),
  ('SEVPURSER', 'Beatriz de Luna', 'PURSER', 7, 1080, 'ESP', 'SVQ', 'Moved a family fortune across three borders without losing a coin.'),
  ('OTTPURSER', 'Rüstem Pasha', 'PURSER', 7.5, 1200, 'OTT', 'IST', 'Grand Vizier, and a byword for squeezing a treasury.'),
  ('MUGPURSER', 'Virji Vora', 'PURSER', 9, 1550, 'MUG', 'SRT', 'The richest merchant in Surat, which is to say in the world.'),
  ('SAKAIPURSER', 'Suminokura Ryōi', 'PURSER', 7, 1050, 'JPN', 'NAG', 'Ran the red-seal trade and cut a river through a mountain.'),
  ('POLPURSER', 'Jan Zamoyski', 'PURSER', 6, 860, 'POL', 'GDA', 'Grain, Gdańsk, and an accountant''s memory for a debt.'),
  ('RUSPURSER', 'Anikey Stroganov', 'PURSER', 6.5, 920, 'RUS', 'COP', 'Salt and furs made the family; he keeps the ledger himself.');
