...
// Moved deliberately 2026-09-06 to 0078, which stops the chain racing its own clock: 0012 wound
// pg_cron at the twelfth migration and 0041 then rewrote port_goods underneath the market tick,
// which deadlocked the apply-proof twice. 0012 now leaves the three jobs INACTIVE and no
// migration starts them; public.wind_the_clock() is the one deliberate call that does.
