...
| ~~**Owner row 73**~~ | **MERGED 2026-09-09 as PR #51.** COMMAND has 0 verb buttons; six verbs were doors that already existed on PORT and were deleted, three moved to their building, SAIL keeps its one door on the MAP. `src/features/command/` 1,305 → 262 lines. **Not driven on production yet** — that is what closes the row. |
