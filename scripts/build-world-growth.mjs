...
begin
  ...
  if v_reachable <> v_ports_all then
    raise exception '${shortNo} self-assert FAIL: % of % ports carry a full reach row — a grown port needs scripts/build-sea-migration.mjs to cut its raster/reaches migration alongside this growth', v_reachable, v_ports_all;
  end if;
